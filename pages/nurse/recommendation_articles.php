...
include("functions/pagenumberart.php");
?>
<!DOCTYPE html>
<html>
            ...
            <main>
                ...
                <div class="card">
                    ...
                    <div class="card-body article-container">
                        ...
                        $query = "SELECT * FROM tbl_recommendation_article ORDER BY recommendation_article_id DESC, date_created DESC LIMIT $offset, $total_records_per_page";
                        $records = mysqli_query($con, $query);
                        foreach ($records as $key => $row) {
                        ?>
                            <div class="card article-card">
                                <a href="<?php echo $row['recommendation_article_url']; ?>" target="_blank">
                                    <div class="card-body">
                                        <h4 id="article-header"><?php echo ucwords($row['recommendation_article_title']); ?></h4>
                                        <p id="article-body"><?php echo $row['recommendation_article_description'] ?></p>
                                    </div>
                                </a>
                            </div>
                        <?php
