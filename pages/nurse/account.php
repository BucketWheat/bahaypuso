...
<body>
    <div class="wrapper">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-container">
                            <form action="crud/updatenurse.php" method="POST" id="account-form">
                                <input type="hidden" name="nurse_fname" id="nurse_fname" value="<?php echo $_SESSION['nurse_fname']; ?>">
                                <input type="hidden" name="nurse_lname" id="nurse_lname" value="<?php echo $_SESSION['nurse_lname']; ?>">
                                ...
                                <div class="form-group">
                                    <input type="submit" value="Update" name="updateNurse" id="updateNurse" class="btn btn-primary" style="background-color: rgb(52, 160, 160); float:right;"></input>
                                </div>
                            </form>
                            <div class="card-body">
        ...
        <script src="../../js/staff_js/load_account_details_nurse.js"></script>
        <script src="../../js/staff_js/check_username_nurse.js"></script>
