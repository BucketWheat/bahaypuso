            ...
            <main>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="../crud/updatehealthinfo_administered.php" method="POST">
                                    <input type="hidden" name="updateID_administered" id="updateID_administered">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" value="Edit" name="editHealthinfo_administered" id="editHealthinfo_administered" class="btn btn-primary" style="background-color: rgb(52, 160, 160);"></input>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="card" style="margin-top: 2rem;">
                    <div class="card-body" style="background-color: rgb(52, 160, 160); color: white;">
                        <h4><strong>Administered Health Records</strong></h4>
                    </div>
                </div>
