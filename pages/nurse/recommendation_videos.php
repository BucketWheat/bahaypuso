...
include("functions/pagenumbervid.php");
?>
<!DOCTYPE html>
<html>
            ...
            <main>
                ...
                <div class="card">
                    ...
                    <div class="card-body video-container">
                        ...
                        $query = "SELECT * FROM tbl_recommendation_video ORDER BY recommendation_video_id DESC, date_created DESC LIMIT $offset, $total_records_per_page";
                        $records = mysqli_query($con, $query);
                        foreach ($records as $key => $row) {
                        ?>
                            <div class="card text-center photo-card">
                                <video width="100%" controls preload="metadata">
                                    <source src="../../uploads/videos/<?php echo $row['recommendation_video_path']?>" type="video/mp4">
                                    <source src="../../uploads/videos/<?php echo $row['recommendation_video_path']?>" type="video/mov">Your browser does not support the video tag.
                                </video>
                                <div class="card-body">
                                    <h5 class="card-title" id="video-header"><?php echo ucwords($row['recommendation_video_title']); ?></h5>
                                    <p class="card-text" id="video-body"><?php echo $row['recommendation_video_description'] ?></p>
                                </div>
                            </div>
                        <?php
                        }
