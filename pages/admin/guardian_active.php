...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <main>
                <!-- Modal in adding new guardian -->
                <div class="modal fade bd-example-modal-lg" id="guardianmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: rgb(52, 160, 160); color: white;">
                                <h5 class="modal-title" id="exampleModalLabel">Add New Guardian</h5>
                            ...
                            <div class="modal-body">
                                <form action="crud/addguardian.php" method="POST">
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="text" class="form-control" name="inputContact" id="inputContact" placeholder="Enter contact no." required maxlength="11">
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" value="Add" name="addGuardian" id="addGuardian" class="btn btn-primary" style="background-color: rgb(52, 160, 160); color: white;"></input>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <!-- Modal in viewing and updating guardian data -->
                <div class="modal fade bd-example-modal-lg" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="crud/updateguardian.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        <input type="submit" value="Update" name="updateGuardian" id="updateGuardian" class="btn btn-primary" style="background-color: rgb(52, 160, 160); color: white;"></input>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body" style="background-color: rgb(52, 160, 160); color: white;">
                        <h4><strong>Active Guardians Account Information</strong></h4>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-right" style="margin-bottom: 1rem;">
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#guardianmodal"><i class="fas fa-plus"></i> Add Guardian</button>
                        </div>
                        <div class="table-responsive">
                            <?php
                            $records_query = "SELECT * FROM tbl_guardian WHERE status != 'Inactive'";
        ...
        <script src="../../js/admin_js/check_username_guardian.js"></script>
        <script src="../../js/admin_js/update_delete_guardian.js"></script>
        ...
        ?>
            <script>
                swal({
                    title: "Data Inserted",
                    text: "New Guardian Successfully Added",
                    icon: "success",
                    button: "Confirm",
                });
            </script>
        ...
        ?>
            <script>
                swal({
                    title: "Data Deleted",
                    text: "Guardian Information Successfully Deleted",
                    icon: "success",
                    button: "Confirm",
                });
            </script>
        ...
        ?>
            <script>
                swal({
                    title: "Data Updated",
                    text: "Guardian Information Successfully Updated",
                    icon: "success",
                    button: "Confirm",
                });
            </script>
        ...
        ?>
            <script>
                swal({
                    ...
                    text: "Guardian Information Update failed",
                    icon: "warning",
                    button: "Confirm",
                });
            </script>
