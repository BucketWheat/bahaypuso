                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="crud/update_donation.php" method="POST">
                ...
                <div class="mainContent donations-main">
                        ...
                        <div class="card-body">
                            <div class="card" style="margin-bottom: 1rem;">
                                <div class="card-body" style="background-color: rgb(52, 160, 160); color: white;">
                                    <h3 class="mb-2"><strong>Cash Donations</strong></h3>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <?php
                                $records_query = "SELECT tbl_donation.donation_id, tbl_donation.donor_id, tbl_donor.fullname, tbl_donor.institution, tbl_donor.contact_number, tbl_donor.address, tbl_donor.email, tbl_donation.donation_category, tbl_donation.amount, tbl_donation.description, tbl_donation.date_recorded, tbl_donation.date_received, tbl_donation.status FROM (tbl_donation INNER JOIN tbl_donor ON tbl_donation.donor_id = tbl_donor.donor_id) WHERE tbl_donation.donation_category = 'Cash' AND tbl_donation.status ='Pending'";
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card" style="margin-bottom: 1rem;">
                                <div class="card-body" style="background-color: rgb(52, 160, 160); color: white;">
                                    <h3 class="mb-2"><strong>Miscellaneous</strong></h3>
                                </div>
                            </div>
                            <!--  <div class="card-body d-flex flex-row justify-content-between">
