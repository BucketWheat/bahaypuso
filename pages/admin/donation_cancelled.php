...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <main>
                <!-- MODAL FOR VIEWING PENDING CASH DONATIONS-->
                <div class="modal fade bd-example-modal-lg" id="modal-pending-cash" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <!-- MODAL FOR VIEWING PENDING MISC DONATIONS-->
                <div class="modal fade bd-example-modal-lg" id="modal-pending-misc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: rgb(52, 160, 160); color: white;">
                                <h5 class="modal-title" id="exampleModalLabel">Donation Details</h5>
                            ...
                            <div class="modal-body">
                                <form action="crud/update_donation_received.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="status-misc" id="status-misc" placeholder="Status" readonly>
                                    </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                ...
                <div class="mainContent donations-main">
                        ...
                        <div class="card-body">
                            <div class="card" style="margin-bottom: 1rem;">
                                <div class="card-body" style="background-color: rgb(52, 160, 160); color: white;">
                                    <h3 class="mb-2"><strong>Cancelled Cash Donations</strong></h3>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <?php
                                $records_query = "SELECT tbl_donation.donation_id, tbl_donation.donor_id, tbl_donor.fullname, tbl_donor.institution, tbl_donor.contact_number, tbl_donor.address, tbl_donor.email, tbl_donation.donation_category, tbl_donation.amount, tbl_donation.description, tbl_donation.date_recorded, tbl_donation.date_received, tbl_donation.status FROM (tbl_donation INNER JOIN tbl_donor ON tbl_donation.donor_id = tbl_donor.donor_id) WHERE tbl_donation.donation_category = 'Cash' AND tbl_donation.status ='Cancelled'";
                                $records = mysqli_query($con, $records_query);
                                ?>
                                <table id="datatable-pending-cash" class="table table-bordered table-hover table-striped" style="width: 100%; text-align: center;">
                                    <thead class="bg-dark text-white">
                                        <tr>
                                            ...
                                            <th scope="col" style="display: none;">Date Received</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td style="display: none;"><?php echo $row['date_received'] ?></td>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card" style="margin-bottom: 1rem;">
                                <div class="card-body" style="background-color: rgb(52, 160, 160); color: white;">
                                    <h3 class="mb-2"><strong>Cancelled Miscellaneous Donations</strong></h3>
                                </div>
                            </div>
                            <!--  <div class="card-body d-flex flex-row justify-content-between">
                            ...
                            <div class="table-responsive">
                                ...
                                $records = mysqli_query($con, $records_query);
                                ?>
                                <table id="datatable-pending-misc" class="table table-bordered table-hover table-striped" style="width: 100%; text-align: center;">
                                    <thead class="bg-dark text-white">
                                        <tr>
                                            <th scope="col">ID</th>
                                            <th scope="col" style="display: none;">Donor ID</th>
