...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <main>
                <!-- Modal in viewing and updating inactive nurse data -->
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="crud/updatenurse_inactive.php" method="POST">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="updateSex_inactive" id="updateSex_inactive" readonly>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="updatePRC_inactive">PRC License Number</label>
                                            <input type="text" class="form-control" name="updatePRC_inactive" id="updatePRC_inactive" pattern="[0-9]{7,}" title="License Number must be 7-digit" placeholder="Enter license number" maxlength="7" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" value="Update" name="updateNurse_inactive" id="updateNurse_inactive" class="btn btn-primary" style="background-color: rgb(52, 160, 160);"></input>
                                    </div>
                                </form>
                            </div>
                        </div>
