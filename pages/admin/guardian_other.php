...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <main>
                <!-- Modal in viewing and updating inactive guardian data -->
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="crud/updateguardian_inactive.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" value="Update" name="updateGuardian_inactive" id="updateGuardian_inactive" class="btn btn-primary" style="background-color: rgb(52, 160, 160); color: white;"></input>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="card" style="margin-top: 2rem;">
                    <div class="card-body" style="background-color: rgb(52, 160, 160); color: white;">
                        <h4><strong>Other Guardians Information</strong></h4>
                    </div>
                </div>
