...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <main>
                <!-- Modal in adding new nurse -->
                <div class="modal fade bd-example-modal-lg" id="nursemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="crud/addnurse.php" method="POST">
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="inputPRC" id="inputPRC" pattern="[0-9]{7,}" title="License Number must be 7-digit" placeholder="Enter license number" maxlength="7">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" value="Add" name="addNurse" id="addNurse" class="btn btn-primary" style="background-color: rgb(52, 160, 160);"></input>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <!-- Modal in viewing and updating nurse data -->
                <div class="modal fade bd-example-modal-lg" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="crud/updatenurse.php" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="updatePRC" id="updatePRC" pattern="[0-9]{7,}" title="License Number must be 7-digit" placeholder="Enter license number" maxlength="7" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        <input type="submit" value="Update" name="updateNurse" id="updateNurse" class="btn btn-primary" style="background-color: rgb(52, 160, 160);"></input>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body" style="background-color: rgb(52, 160, 160); color: white;">
                        <h4><strong>Active Nurses Information</strong></h4>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-right" style="margin-bottom: 1rem;">
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#nursemodal"><i class="fas fa-plus"></i> Add Nurse</button>
                        </div>
                        <div class="table-responsive">
                            <?php
                            $records_query = "SELECT * FROM tbl_nurse WHERE status != 'Inactive'";
        ...
        <script src="../../js/admin_js/check_username_nurse.js"></script>
        <script src="../../js/admin_js/update_delete_nurse.js"></script>
        ...
        ?>
            <script>
                swal({
                    title: "Data Inserted",
                    text: "New Nurse Successfully Added",
                    icon: "success",
                    button: "Confirm",
                });
            </script>
        ...
        ?>
            <script>
                swal({
                    title: "Data Deleted",
                    text: "Nurse Information Successfully Deleted",
                    icon: "success",
                    button: "Confirm",
                });
            </script>
        ...
        ?>
            <script>
                swal({
                    title: "Data Updated",
                    text: "Nurse Information Successfully Updated",
                    icon: "success",
                    button: "Confirm",
                });
            </script>
