                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="../crud/updatehealthinfo_canncelled.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <!-- <input type="submit" value="Edit" name="editHealthinfo_cancelled" id="editHealthinfo_cancelled" class="btn btn-primary" style="background-color: rgb(52, 160, 160);"></input> -->
                                    </div>
                                </form>
                            </div>
                        </div>
